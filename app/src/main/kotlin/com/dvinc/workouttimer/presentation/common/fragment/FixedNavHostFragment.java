package com.dvinc.workouttimer.presentation.common.fragment;
 ...
 *                \ . . .        \\                                 _--_/ _/
 *                 \              \\                              _- _/ _/
 *                 \               \\                      ___-(O) _/ _/    HavHostFragment don't work with Android X.
 *                 \                \                  __--  __   /_ /      Don't know why and i don't care.
 *                 \                 \\          ____--__----  /    \_      And i fixed it by stupid way.
 *                  \                  \\       -------       /   \_  \_
 *                   \                   \                  //   // \__ \_
 *                    \                   \\              //   //      \_ \_
 *                     \                   \\          ///   //          \__-
...
public class FixedNavHostFragment extends Fragment implements NavHost {
    ...
    /**
     * Create a new FixedNavHostFragment instance with an inflated {@link NavGraph} resource.
     *
     * @param graphResId resource id of the navigation graph to inflate
     * @return a new FixedNavHostFragment instance
     */
    @NonNull
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mGraphId != 0) {
            ...
            // See if it was set by FixedNavHostFragment.create()
    ...
    /**
     * Create the FragmentNavigator that this FixedNavHostFragment will use. By default, this uses
     * {@link FragmentNavigator}, which replaces the entire contents of the FixedNavHostFragment.
     * <p>
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        // hierarchy in cases where the FixedNavHostFragment is added programmatically as is required
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // When added via XML, the parent is null and our view is the root of the FixedNavHostFragment
        // but when added programmatically, we need to set the NavController on the parent - i.e.,
        // the View that has the ID matching this FixedNavHostFragment.
    ...
    public void onInflate(@NonNull Context context, @NonNull AttributeSet attrs,
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, androidx.navigation.fragment.R.styleable.NavHostFragment);
        final int graphId = a.getResourceId(androidx.navigation.fragment.R.styleable.NavHostFragment_navGraph, 0);
        final boolean defaultHost = a.getBoolean(androidx.navigation.fragment.R.styleable.NavHostFragment_defaultNavHost, false);
